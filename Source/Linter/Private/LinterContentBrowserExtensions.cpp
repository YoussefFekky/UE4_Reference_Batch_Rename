	...
	struct Local
	{
		...
		static void ContentBrowserExtenderFunc(FMenuBuilder& MenuBuilder, const TArray<FString> SelectedPaths)
		{
			MenuBuilder.BeginSection("LinterContentBrowserContext", LOCTEXT("CB_LinterHeader", "Linter"));
			{
				...
				MenuBuilder.AddMenuEntry(
                    LOCTEXT("CB_IgnoreFolder", "Ignore folder"),
                    LOCTEXT("CB_IgnoreFolder_Tooltip", "Suffix assets in folder with '_ig'"),
                    FSlateIcon(FLinterStyle::GetStyleSetName(), "Linter.Toolbar.Icon"),
                    FUIAction(FExecuteAction::CreateLambda([SelectedPaths]()
                    {
                    	UE_LOG(LinterContentBrowserExtensions, Display, TEXT("Starting folder ignore."));
                    	FDlgBatchRenameTool AssetDlg;
                        AssetDlg.IgnoreAssets(true, SelectedPaths);
                    })),
                    NAME_None,
                    EUserInterfaceActionType::Button);

				MenuBuilder.AddMenuEntry(
                    LOCTEXT("CB_UnignoreFolder", "Unignore folder"),
                    LOCTEXT("CB_UnignoreFolder_Tooltip", "Remove '_ig' suffix from assets in folder"),
                    FSlateIcon(FLinterStyle::GetStyleSetName(), "Linter.Toolbar.Icon"),
                    FUIAction(FExecuteAction::CreateLambda([SelectedPaths]()
                    {
                        UE_LOG(LinterContentBrowserExtensions, Display, TEXT("Starting folder unignore."));
                        FDlgBatchRenameTool AssetDlg;
                        AssetDlg.IgnoreAssets(false, SelectedPaths);
                    })),
                    NAME_None,
                    EUserInterfaceActionType::Button);
			}
		...
		static void AssetExtenderFunc(FMenuBuilder& MenuBuilder, const TArray<FAssetData> SelectedAssets)
		{
			MenuBuilder.BeginSection("LinterAssetContext", LOCTEXT("CB_LinterHeader", "Linter"));
			{
				...
				if (bAnyAssetCanBeRenamed)
				{
					...
					MenuBuilder.AddMenuEntry(
                        LOCTEXT("CB_IgnoreAssets", "Ignore assets"),
                        LOCTEXT("CB_IgnoreAssets_Tooltip", "Suffix selected assets and their references with '_ig'"),
                        FSlateIcon(FLinterStyle::GetStyleSetName(), "Linter.Toolbar.Icon"),
                        FUIAction(FExecuteAction::CreateLambda([SelectedAssets]()
                        {
                            UE_LOG(LinterContentBrowserExtensions, Display, TEXT("Starting ignore."));
                            FDlgBatchRenameTool AssetDlg(SelectedAssets);
                            AssetDlg.IgnoreAssets(true);
                        })),
                        NAME_None,
                        EUserInterfaceActionType::Button);

					MenuBuilder.AddMenuEntry(
                        LOCTEXT("CB_UnignoreAssets", "Unignore assets"),
                        LOCTEXT("CB_UnignoreAssets_Tooltip", "Remove the '_ig' suffix from selected assets and their references"),
                        FSlateIcon(FLinterStyle::GetStyleSetName(), "Linter.Toolbar.Icon"),
                        FUIAction(FExecuteAction::CreateLambda([SelectedAssets]()
                        {
                            UE_LOG(LinterContentBrowserExtensions, Display, TEXT("Starting unignore."));
                            FDlgBatchRenameTool AssetDlg(SelectedAssets);
                            AssetDlg.IgnoreAssets(false);
                        })),
                        NAME_None,
                        EUserInterfaceActionType::Button);
				}
