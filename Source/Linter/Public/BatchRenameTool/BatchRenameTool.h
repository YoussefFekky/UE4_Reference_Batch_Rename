...
public:
	...
	void IgnoreAssets(bool bIgnore);
	void IgnoreAssets(bool bIgnore, const TArray<FString>& PackagePaths);
...
private:
	...
	void ApplyBatchRename(TArray<struct FAssetRenameData>& AssetsAndNames, const FAssetData& Asset, class FAssetRegistryModule& AssetRegistryModule, TArray<FAssetData>& AllAssets);
	void ApplySuffix(TArray<FAssetRenameData>& AssetsAndNames, const FAssetData& Asset, FAssetRegistryModule& AssetRegistryModule, TArray<FAssetData>& AllAssets);
